    ...
    <div class="container d-flex my-5">
        <img class="ms-auto me-2 rounded-pill w-25 h-25" src="../img/image(6).jpeg" alt="">
        <p class="col-4">Consulta presencial: é realizada em um consultório com todo conforto, aqui também faço a avaliação física com uso de adipômetro.</p>
    </div>
    
    <div class="container d-flex my-5">
        <img class="me-2 rounded-pill w-25 h-25" src="../img/image(3).jpeg" alt="">
        <p class="col-4">Consulta on-line: o antendimento é realizado através de chamada de vídeo. Para avaliação da sua evolução física, te envio um Ebook ensinando com realizar suas medidas corporais em casa.</p>
    </div>